odoo.define('production_quantity_tracking_by_employee.kiosk_mode', function (require) {
"use strict";
...
var KioskMode = Widget.extend(BarcodeHandlerMixin, {
    events: {
        "click .o_hr_attendance_button_employees": function(){ this.do_action('production_quantity_tracking_by_employee.produced_qty_employee_attendance_action_kanban'); },
    },
...
core.action_registry.add('produced_qty_attendance_kiosk_mode', KioskMode);
